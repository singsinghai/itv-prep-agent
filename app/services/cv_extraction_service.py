...
class CVExtractionService:
    ...
    @timed("cv_extraction.extract_job_experiences_from_text")
    async def extract_job_experiences_from_text(self, cv_text: str) -> list[JobExperience]:
        ...
        result = await asyncio.to_thread(
            chain.invoke,
            {"cv_text": cv_text[: self._settings.max_cv_chars]},
        )
